...
import { Consumer, ConsumerConfig, Message } from 'pulsar-client';
import { requireClient, requireSchema } from '../PulsarNode';
import { consumerConfig } from '../PulsarConfig';
...
export = (RED: NodeRED.NodeAPI): void => {
    RED.nodes.registerType(
        ...
        function (this: ConsumerNode, config: PulsarConsumerConfig): void {
            ...
            try {
                this.debug(
                    'Creating consumer: ' + JSON.stringify(consumerConfig),
                );
                requirement
                    .subscribe(consumerConfig)
                    .then((consumer) => {
                        ...
                        const message = {
                            ...
                            payload: {
                                ...
                                subscriptionType:
                                    consumerConfig.subscriptionType,
                            },
                        };
